  ...
  private class InfoGramDriver extends Driver {
    ...
    public final void buildModel() {
      ...
      try {
        ...
        model._output.extractAdmissibleFeatures(_varImp, _topKPredictors, _cmi, _parms._conditional_info_threshold,
                _parms._varimp_threshold);  // copy admissible information model output
